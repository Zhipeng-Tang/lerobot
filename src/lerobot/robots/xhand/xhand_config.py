...
class XHandConfig(RobotConfig):
    ...
    # EtherCAT settings
    ethercat_interface: str = "enp129s0"  # Network interface for EtherCAT (e.g., "eth0", "enp3s0")
    ethercat_slave_id: int = 0  # EtherCAT slave ID (0 for auto-detect)
    ...
    home_position_deg: tuple = (0, 80.66, 33.2, 0.00, 5.11, 5.0, 
