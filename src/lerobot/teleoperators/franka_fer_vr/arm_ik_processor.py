...
class ArmIKProcessor:
    ...
    def __init__(self, config=None):
        ...
        self.q7_min = -3.0159  # Default Franka Q7 limits
        self.q7_max = 3.0159
    ...
    def setup(self, neutral_pose: List[float], initial_robot_pose: List[float], 
              ...
              q7_min: float = -3.0159, q7_max: float = 3.0159):
        """
    ...
    def process_wrist_data(self, wrist_data, current_joints: List[float], current_obs) -> Dict[str, float]:
        """
    ...
    def _compute_target_pose(self, wrist_data, current_joints):
        ...
        # print("="*10, robot_position, robot_quaternion)
        if not self.vr_initialized:
