...
def main():
    ...
    policy_config = DiffusionConfig(
        ...
        input_features={
            ...
            "observation.images.head_view": PolicyFeature(
                type=FeatureType.VISUAL,
                shape=(3, 240, 320)  # head view camera original size
            ),
            "observation.images.front_left_view": PolicyFeature(
                type=FeatureType.VISUAL,
                shape=(3, 240, 320)  # front left view camera original size
            ),
            "observation.images.wrist_view": PolicyFeature(
                type=FeatureType.VISUAL,
                shape=(3, 240, 320)  # wrist view camera original size
            )
        },
        output_features={
