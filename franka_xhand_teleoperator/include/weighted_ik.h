...
private:
    ...
    static constexpr std::array<double, 7> JOINT_RANGES = {{
        ...
        5.4874,  // A1: [-166°, 166°] = [-2.898, 2.898] rad
        3.5674,  // A2: [-101°, 101°] = [-1.762, 1.762] rad  
        5.8014,  // A3: [-166°, 166°] = [-2.898, 2.898] rad
        2.8903,  // A4: [-176°, -4°] = [-3.071, -0.070] rad
        5.613,  // A5: [-166°, 166°] = [-2.898, 2.898] rad
        3.9724,  // A6: [-1°, 215°] = [-0.017, 3.752] rad
        6.0318   // A7: [-166°, 166°] = [-2.898, 2.898] rad
    }};
